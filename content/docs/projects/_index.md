...
{{< card  title="SBOM Generator and library" footer="<a href='https://github.com/anchore/syft'>Syft GitHub Repo</a> | <a href=/docs/user-guides/sbom/getting-started>SBOM Generation Guide</a>" >}}
...
{{< card title="Vulnerability Scanner" footer="<a href='https://github.com/anchore/grype'>Grype GitHub Repo</a> | <a href=/docs/user-guides/vulnerability/getting-started>Vulnerability Scanning Guide</a>" >}}
...
{{< card title="License Scanner" footer="<a href='https://github.com/anchore/grant'>Grant GitHub Repo</a> | <a href=/docs/user-guides/license/getting-started>License Scanning Guide</a>">}}
