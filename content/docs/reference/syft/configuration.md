...
{{< alert title="Note" >}}
This documentation was generated with Syft version `1.50.0`.
{{< /alert >}}
...
golang:
  ...
  # "none" (disabled), "stdlib" (only the synthetic stdlib package), and "all" (all module packages plus stdlib) (env: SYFT_GOLANG_CAPTURE_SYMBOLS)
