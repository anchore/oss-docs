...
Examples:
  ...
  SYFT_CONVERT_PASSTHROUGH_EXACT_FORMAT=true syft convert img.syft.json -o syft-json=out.syft.json    copy the input to "out.syft.json" unchanged if it is already syft-json at the current schema version
