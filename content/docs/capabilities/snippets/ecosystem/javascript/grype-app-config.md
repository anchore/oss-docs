<!-- AUTO-GENERATED by src/generate_capability_vulnerability_tables.py -- DO NOT MANUALLY EDIT -->
...
<table class="config-table grype-config-table">
  ...
  <tbody>
    <tr>
      <td class="col-config-key"><code>match.javascript.using-cpes</code></td>
