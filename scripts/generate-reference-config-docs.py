...
"""
    ...
    if config_output:
        ...
        raise RuntimeError(f"Failed to retrieve configuration from the image '{image}'.")

    return content


def main():
    parser = argparse.ArgumentParser(description='Generate configuration reference documentation')
    ...
    print(f"Generating configuration docs for {args.tool_name} using image {args.image}...")
